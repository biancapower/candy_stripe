...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { customer_id_id: @purchase.customer_id_id, item_id_id: @purchase.item_id_id } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { customer_id_id: @purchase.customer_id_id, item_id_id: @purchase.item_id_id } }
